...
import pl.spcode.navauth.docsgen.generator.common.MigratedPluginTypesGenerator
...
val generatorsRegistry =
  listOf(EventsGenerator(), CommandsGenerator(), MigratedPluginTypesGenerator())
