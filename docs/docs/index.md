...
hero:
  name: "NavAuth"
  image:
    src: navauth-logo.svg
    alt: Nav auth logo
  text: "official docs page"
  tagline: Migrate now from other auth plugins like FastLogin, AuthMe, LibreLogin!
  actions:
    - theme: brand
      text: View docs
      link: /offer
...
features:
  - icon: 👑
    title: Why NavAuth?
    details: Check the detailed description of what we offer.
    link: /offer
  - icon: ⚡
